...
var chekHeader = _.throttle(() => {
	...
	if (!(window.matchMedia('(max-width: 768px)').matches)) {
		...
		if (scrollPosition > 100) {
			...
			$('.scroll .logos__img').css({ "animation": "scroll_logos 0.2s ease-out", "transform": "scale(0.7)" });
			$('.scroll .logos__img-avatar').css({ "animation": "scroll_logos 0.2s ease-out", "transform": "scale(0.7)" });
			$('.scroll .logos__img-hover').css({ "animation": "scroll_logos 0.2s ease-out", "transform": "scale(0.7)" });
		}
		//if not, remove class from header
		else {
			$('.scroll .logos__img').css({ "animation": "unscroll_logos 0.2s ease-out", "transform": "scale(1)" });
			$('.scroll .logos__img-avatar').css({ "animation": "uscroll_logos 0.2s ease-out", "transform": "scale(1)" });
			$('.scroll .logos__img-hover').css({ "animation": "uscroll_logos 0.2s ease-out", "transform": "scale(1)" });
