...
$('.logos__img-border').mouseover(function() {
    $('.logos__img-hover').css('opacity', 1);
})
$('.logos__img-border').mouseout(function() {
    $('.logos__img-hover').css('opacity', 0);
})
...
(function() {
    ...
    function e(t) { return null == t ? t === l ? d : y : I && I in Object(t) ? n(t) : r(t) }

    function n(t) {
        var e = $.call(t, I),
            n = t[I];
        try { t[I] = l; var r = true } catch (t) {}
        var o = _.call(t);
        return r && (e ? t[I] = n : delete t[I]), o
    }

    function r(t) { return _.call(t) }
    ...
    function o(t, e, n) {
        ...
        function o(t) { return x = t, O = setTimeout(c, e), T ? r(t) : v }
        ...
        function p(t) { return O = l, S && d ? r(t) : (d = g = l, v) }

        function s() { O !== l && clearTimeout(O), x = 0, d = h = g = O = l }

        function y() { return O === l ? v : p(D()) }

        function m() {
            var t = D(),
                n = f(t);
            if (d = arguments, g = this, h = t, n) { if (O === l) return o(h); if (w) return O = setTimeout(c, e), r(h) }
    ...
    function i(t, e, n) {
        var r = true,
            i = true;
        if (typeof t != "function") throw new TypeError(b);
        return u(n) && (r = "leading" in n ? !!n.leading : r, i = "trailing" in n ? !!n.trailing : i), o(t, e, { leading: r, maxWait: e, trailing: i })
    }

    function u(t) { var e = typeof t; return null != t && ("object" == e || "function" == e) }

    function f(t) { return null != t && typeof t == "object" }

    function c(t) { return typeof t == "symbol" || f(t) && e(t) == m }
...
//scrolling
var chekHeader = _.throttle(() => {

    //Detect  scroll position
    let scrollPosition = Math.round(window.scrollY);

    //if we've scrolled 108px, add "scroll" class to the header
    if (scrollPosition > 108) {
        $('.scroll .logos__img').css("animation: scroll_logos 0.4s ease");
        $('.header').addClass('scroll');
    }
    //if not, remove class from header
    else {
        $('.scroll .logos__img').css("animation: unscroll_logos 0.4s ease");
        $('.header').removeClass('scroll');
    }
}, 100)

window.addEventListener('scroll', chekHeader);
