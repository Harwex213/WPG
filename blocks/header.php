		...
		<div class="header-body">
			<div class="logos">
				...
				<a href="#" class="logos__bestWPG">
					<img src="<?php echo $path?>img/header/best_wpg.png" alt="Logo of Best WPG" class="logos__img">
					<img src="<?php echo $path?>img/header/best_wpg_hover.png" alt="Logo hover of Best WPG" class="logos__img-hover">
				</a>
			</div>
			<div class="navbar">
